...
def plot_daily():
	...
	plt.figure('2019-noCov疫情统计表', facecolor='#f4f4f4', figsize=(10, 8))
	plt.title('2019-noCov疫情曲线', fontsize=20)
...
def plot_distribution():
	...
	axes.set_title('2019-noCov疫情地图', fontproperties=font_14)
	FigureCanvasAgg(fig)
	fig.savefig('2019-noCov疫情地图.png')
