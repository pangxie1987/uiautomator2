...
class XML_CSV():
    ...
    def read_xml_to_csv(self, csv_file, xmlfile):
        ...
        spamwriter.writerow(['suit', 'name', 'node_order', 'details', 'internalid','externalid','summary','steps','expectedresults','caseno'])
                            ...
                            if step.tag == 'step':
                                for action in step:
                                    ...
                                    if action.tag == 'actions':
                                        ...
                                        case_list[7] = self.strip_tags(str(action.text))
